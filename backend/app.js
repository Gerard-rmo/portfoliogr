...
import presseRoutes from "./routes/presseRoutes.js"; // Importation des routes des articles de presse.
...
app.use("/api/presse", presseRoutes); // Routes des articles de presse.
